...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="v2_pipeline/checkpoints/dqn/foundation_env/default/model_checkpoint.npz")
    parser.add_argument("--policy-path", default="outputs/v2_outputs/rl_dqn/policy.json")
