...
def main() -> None:
    ...
    parser.add_argument("--summary", default="outputs/v2_outputs/all_algorithms/summary_metrics.csv")
    parser.add_argument("--policy-path", default="outputs/v2_outputs/rl/policy.json")
    parser.add_argument("--mdp-meta", default="outputs/v2_outputs/mdp/mdp_meta.json")
    parser.add_argument("--outdir", default="outputs/v2_outputs/figures")
