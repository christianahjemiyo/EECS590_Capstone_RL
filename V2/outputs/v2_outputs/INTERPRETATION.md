...
- `outputs/v2_outputs/mdp/*_value_bar.png`: how valuable each risk-state is under the learned plan.
- `outputs/v2_outputs/mdp/*_policy_bar.png`: which action each state is assigned.
- `outputs/v2_outputs/figures/rl_learning_curve.png`: how quickly RL improves with more episodes.
- `outputs/v2_outputs/figures/algo_avg_return_comparison.png`: side-by-side comparison of final performance.
...
- V2 is fully reproducible: preprocessing, training, and figures are versioned with results.
