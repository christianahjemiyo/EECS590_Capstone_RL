...
```powershell
python scripts/run_world_model_v3.py --mdp ../V2/outputs/v2_outputs/mdp/mdp.npz --outdir outputs/V3/world_model
python scripts/make_world_model_figures.py
python scripts/run_bayesian_reward_tuning.py --base-config ../V2/v2_pipeline/configs/mdp_sim_mimic.json --outdir outputs/V3/bayesian_tuning
